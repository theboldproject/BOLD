Contributing to Bold Core
============================

The Bold Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bold Core project, and is not to be
confused with overall Bold Network Protocol consensus changes.

Whether a pull request is merged into Bold Core rests with the project merge
...
Patches that change Bold consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bold consensus, it must have been
...
The project leader is the release manager for each Bold Core release.
