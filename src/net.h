...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemamonetaryunitGrant* grantOutbound = NULL, const char* strDest = NULL, bool fOneShot = false);
...
public:
    ...
    CSemamonetaryunitGrant grantOutbound;
