...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::BOLD)
    {
    }
...
void OverviewPage::getPercentage(CAmount nUnlockedBalance, QString& sBOLDPercentage)
{
    int nPrecision = 2;
    ...
    sBOLDPercentage = "(" + QLocale(QLocale::system()).toString(dPercentage, 'f', nPrecision) + " %)";
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    // Percentage labels
    ui->labelBOLDPercent->setText(sPercentage);
    ...
    bool showBOLDAvailable = settingShowAllBalances || phrAvailableBalance != nTotalBalance;
    bool showWatchOnlyBOLDAvailable = watchOnlyBalance != nTotalWatchBalance;
    bool showBOLDPending = settingShowAllBalances || unconfirmedBalance != 0;
    bool showWatchOnlyBOLDPending = watchUnconfBalance != 0;
    bool showBOLDLocked = settingShowAllBalances || nLockedBalance != 0;
    bool showWatchOnlyBOLDLocked = nWatchOnlyLockedBalance != 0;
    bool showImmature = settingShowAllBalances || immatureBalance != 0;
    bool showWatchOnlyImmature = watchImmatureBalance != 0;
    bool showWatchOnly = nTotalWatchBalance != 0;
    ui->labelBalance->setVisible(showBOLDAvailable || showWatchOnlyBOLDAvailable);
    ui->labelBalanceText->setVisible(showBOLDAvailable || showWatchOnlyBOLDAvailable);
    ui->labelWatchAvailable->setVisible(showBOLDAvailable && showWatchOnly);
    ui->labelUnconfirmed->setVisible(showBOLDPending || showWatchOnlyBOLDPending);
    ui->labelPendingText->setVisible(showBOLDPending || showWatchOnlyBOLDPending);
    ui->labelWatchPending->setVisible(showBOLDPending && showWatchOnly);
    ui->labelLockedBalance->setVisible(showBOLDLocked || showWatchOnlyBOLDLocked);
    ui->labelLockedBalanceText->setVisible(showBOLDLocked || showWatchOnlyBOLDLocked);
    ui->labelWatchLocked->setVisible(showBOLDLocked && showWatchOnly);
