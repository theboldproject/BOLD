...
In order to support loading of multiple wallets in bold-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bold.cpp.
...
Changes to bold.cpp
----------------------
bold.cpp is the entry point into bold-qt, and as such, will require some minor modifications to provide hooks for
