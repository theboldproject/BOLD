...
This mechanism has been integrated into Bitcore-Node-Bold which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/boldproject/insight-api-bold#web-socket-api](https://github.com/boldproject/insight-api-bold#web-socket-api) 
* API: [https://github.com/boldproject/insight-api-bold#swifttx-transactions](https://github.com/boldproject/insight-api-bold#swifttx-transactions) 
...
By default, the Bold Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bold Core daemon:
